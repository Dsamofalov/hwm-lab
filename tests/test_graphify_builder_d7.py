...
class MissingNodeSemanticDiagnosticTests(unittest.TestCase):
    def test_complete_partition_relations_provenance_and_collisions(self):
        ...
        self.assertEqual(line["source_type_counts"], [[".hpp", "code", 1]])
        self.assertEqual(line["source_type_incoming_relation_context"], [[".hpp", "code", "defines", "field", 1]])
        self.assertEqual(line["source_type_outgoing_relation_context"], [])
        self.assertEqual(line["source_type_structural_parent_kinds"], [[".hpp", "code", "type:class", 1]])
        self.assertEqual(line["source_type_degree_pairs"], [[".hpp", "code", 1, 0, 1]])
        ...
        self.assertEqual(text["source_type_counts"], [["", "code", 1]])
        self.assertEqual(text["source_type_incoming_relation_context"], [["", "code", "references", "field", 1]])
        self.assertEqual(text["source_type_degree_pairs"], [["", "code", 1, 0, 1]])
